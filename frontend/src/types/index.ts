...
export type CheckInStatus='pending'|'improved'|'still_troubled'|'revoked';
export type CheckInSource='dashboard'|'moods';
export type CheckInResult='improved'|'still_troubled';
...
export interface MoodCheckIn {id:number;user_id:number;trigger_date:string;check_in_date:string;status:CheckInStatus;source:CheckInSource;mood_level:number;result_note:string;responded_at:string|null;revoked_at:string|null;created_at:string;updated_at:string}
